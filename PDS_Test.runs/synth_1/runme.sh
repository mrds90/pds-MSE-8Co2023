...
HD_PWD='/home/marcos/Repositorios/PDS_Test/PDS_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiComponente.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiComponente.tcl
